...
internal class PacketBuffer
{
	...
	public void Resize(int newSize)
	{
		...
		byte[] qPglBWUh800LD2zOUBKLzdmDNXl = this.Bytes;
		this.Bytes = new byte[newSize];
		this.Bytes[0] = qPglBWUh800LD2zOUBKLzdmDNXl[0];
		this.Bytes[1] = qPglBWUh800LD2zOUBKLzdmDNXl[1];
		this.Bytes[2] = qPglBWUh800LD2zOUBKLzdmDNXl[2];
		this.Bytes[3] = qPglBWUh800LD2zOUBKLzdmDNXl[3];
	}
