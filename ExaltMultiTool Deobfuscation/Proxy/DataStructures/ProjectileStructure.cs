...
namespace ExaltMultiTool.Proxy.DataStructures
{
	...
	public class ProjectileStructure : IDataStructure<byte>
	{
		...
		public ProjectileStructure(XElement projectile)
		{
			...
			this.Wavy = projectile._v94aD6xnI4gMG97iMJhl8NatmPCb("Wavy");
			this.Parametric = projectile._v94aD6xnI4gMG97iMJhl8NatmPCb("Parametric");
			this.Boomerang = projectile._v94aD6xnI4gMG97iMJhl8NatmPCb("Boomerang");
			this.ArmorPiercing = projectile._v94aD6xnI4gMG97iMJhl8NatmPCb("ArmorPiercing");
			this.MultiHit = projectile._v94aD6xnI4gMG97iMJhl8NatmPCb("MultiHit");
			this.PassesCover = projectile._v94aD6xnI4gMG97iMJhl8NatmPCb("PassesCover");
			vd3MkegZcmAlOIaxEUrAAtlp91A._1wkC6aK6Vm0MswSRo8G4ZBODjWn = new Dictionary<string, float>();
			projectile.Elements("ConditionEffect")._mDNyNFYbqpk6ULly4BYiq6ShWsn(new Action<XElement>(vd3MkegZcmAlOIaxEUrAAtlp91A._7qT03toc6JWCJ7vt3WXcUBYQn7k));
