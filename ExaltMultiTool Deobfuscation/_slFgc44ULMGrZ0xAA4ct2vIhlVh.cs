...
internal class o3Helper
{
	...
	{
		this._vb0DX76k2oGNsxzar6rSoSPQjNG = (mapInfo._Jp3DtIV4aAYZY26sVsXpPQjBRGO == "Oryx's Sanctuary");
	}

	// Token: 0x06000502 RID: 1282 RVA: 0x0001D80C File Offset: 0x0001BA0C
	public void _9BgsXisaUbFFlj5HLRd76sERUUX(_7k8aOfI7MhNrVnHioUXbsPAxkbm enemyHit)
	{
	...
	public void Update(UpdatePacket update)
	{
		...
		{
			if (eTOyUHUGABMgTlUf3FUyHRn1uVv._koPitlGqCPegcnIS2B6efWzp4zO == 45363)
			{
			...
			{
				if (eTOyUHUGABMgTlUf3FUyHRn1uVv._koPitlGqCPegcnIS2B6efWzp4zO != 8701)
				{
					if (eTOyUHUGABMgTlUf3FUyHRn1uVv._koPitlGqCPegcnIS2B6efWzp4zO == 8702)
					{
						this._8niSHNdstFUpUXKm5glDNGpsIDb = eTOyUHUGABMgTlUf3FUyHRn1uVv.Status.ObjectId;
					}
					else if (eTOyUHUGABMgTlUf3FUyHRn1uVv._koPitlGqCPegcnIS2B6efWzp4zO != 8703)
					{
						if (eTOyUHUGABMgTlUf3FUyHRn1uVv._koPitlGqCPegcnIS2B6efWzp4zO == 9635)
						{
	...
	internal void _IDtpCgDjmC1AQOcZCJSFNAYjlbH(_CBwOjnzusZzuPkHfx7wuwePHqrf text)
	{
		if (!this._vb0DX76k2oGNsxzar6rSoSPQjNG)
		{
			return;
		...
		Console.WriteLine("O3 text: <" + text._Jp3DtIV4aAYZY26sVsXpPQjBRGO + "> " + text._IDtpCgDjmC1AQOcZCJSFNAYjlbH);
		this._jD069csRPo3TtZu4eUegBA1njRh = this._KbHw3Ra3u250PHwUB4Qi44L9irF.Contains(text._IDtpCgDjmC1AQOcZCJSFNAYjlbH);
	}
