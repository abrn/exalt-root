...
internal class ItemStructure : IDataStructure<ushort>
{
	// Token: 0x06000525 RID: 1317 RVA: 0x0001EDBC File Offset: 0x0001CFBC
	internal static Dictionary<ushort, ItemStructure> _gKKd0PApBLw4Hl4Oj4Z6UarwYVc(XDocument doc)
	{
		ItemStructure._scX3EzcsG7EnfglOEZnrcQOXMvg scX3EzcsG7EnfglOEZnrcQOXMvg = new ItemStructure._scX3EzcsG7EnfglOEZnrcQOXMvg();
		scX3EzcsG7EnfglOEZnrcQOXMvg._Kndj0w1wpl2a6oPYP8TaQVSkPtR = new Dictionary<ushort, ItemStructure>();
		doc.Element("Objects").Elements("Object").Where(new Func<XElement, bool>(ItemStructure._pEFaz9qb0BYKJUd5mVB8ZFXUwMg.<>9._GCBlMH3OTN6TV6oACvglvvrOmTR)).ForEach(new Action<XElement>(scX3EzcsG7EnfglOEZnrcQOXMvg._fFWNtW4btW9NFPrxjFKOW6uqCMp));
...
*/;
	...
	private void _7pEdStpqTzVAkmRmG6QdEDbT3PrA(IEnumerable<XElement> activateXMLs)
	{
		...
		{
			this._dHPNoGlmrfb0cl4aaEGpRxXcgRw.Add(new Activate(activate));
		}
	}
	...
	public ExaltMultiTool.Proxy.DataStructures.ProjectileStructure _hEKV2n49EDOyZ8ibopOnEaZqWkk;
	...
	public List<Activate> _dHPNoGlmrfb0cl4aaEGpRxXcgRw;
	...
	private sealed class _scX3EzcsG7EnfglOEZnrcQOXMvg
	{
		...
		public Dictionary<ushort, ItemStructure> _Kndj0w1wpl2a6oPYP8TaQVSkPtR;
	}
	...
	private sealed class _pEFaz9qb0BYKJUd5mVB8ZFXUwMg
	{
		...
		{
			return elem.HasElement("Item");
		}

		// Token: 0x0400068C RID: 1676
		public static readonly ItemStructure._pEFaz9qb0BYKJUd5mVB8ZFXUwMg <>9 = new ItemStructure._pEFaz9qb0BYKJUd5mVB8ZFXUwMg();
